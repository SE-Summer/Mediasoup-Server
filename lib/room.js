...
var Room = /** @class */ (function (_super) {
    ...
    Room.prototype._handleRequest = function (peer, request, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, displayName, joined, device, rtpCapabilities, joinedPeers, peerInfos_1, _c, sctpCapabilities, transportType, webRtcTransportOptions, transport, _d, transportId, dtlsParameters, transport, subscribeIds, subscribedInfo, _i, subscribeIds_1, id, subscribedPeer, _e, _f, producer, _g, _h, _j, transportId, kind, rtpParameters, appData, transport, error, producer_1, joinedPeers, producerId, producer, error, producerId, producer, error, producerId, producer, error, consumerId, consumer, error, consumerId, consumer, error;
            var _this = this;
