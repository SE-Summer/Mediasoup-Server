...
var PeerImpl = /** @class */ (function (_super) {
    ...
    PeerImpl.prototype.getAllAudioProducer = function () {
        return Array.from(this.producers.values())
            .filter(function (p) { return p.kind === 'audio'; });
    };
    PeerImpl.prototype.getAllConsumer = function () {
        return Array.from(this.consumers.values());
    };
    PeerImpl.prototype.getAllDataConsumer = function () {
    ...
    PeerImpl.prototype.setPeerInfo = function (_a) {
        var displayName = _a.displayName, avatar = _a.avatar, joined = _a.joined, closed = _a.closed, device = _a.device, rtpCapabilities = _a.rtpCapabilities, sctpCapabilities = _a.sctpCapabilities;
