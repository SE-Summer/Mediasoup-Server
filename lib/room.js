...
var Room = /** @class */ (function (_super) {
    ...
    Room.prototype._getJoinedPeers = function (_a) {
        ...
        return this._peers
            .filter(function (peer) { return peer !== excludePeer; });
    };
    Room.prototype.createTransport = function (_a) {
        var peerId = _a.peerId, sctpCapabilities = _a.sctpCapabilities;
        return __awaiter(this, void 0, void 0, function () {
            var webRtcTransportOptions, peer, transport;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    Room.prototype.connectTransport = function (_a) {
        var peerId = _a.peerId, transportId = _a.transportId, dtlsParameters = _a.dtlsParameters;
        return __awaiter(this, void 0, void 0, function () {
            var peer, transport;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    Room.prototype.createProducer = function (_a) {
        var peerId = _a.peerId, transportId = _a.transportId, kind = _a.kind, rtpParameters = _a.rtpParameters;
        return __awaiter(this, void 0, void 0, function () {
            var peer, transport, producer;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        peer = this._peers.get(peerId);
    ...
    Room.prototype._handleRequest = function (peer, request, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, displayName, joined, device, rtpCapabilites, joinedPeers, peerInfos, _c, sctpCapabilities, transportType, webRtcTransportOptions, transport, _d, transportId, dtlsParameters, transport, subscribeId, subscribedInfo_1, _e, transportId, kind, rtpParameters, appData, transport, error, producer_1, joinedPeers;
            var _this = this;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case global_1.RequestMethod.resumeProducer: return [3 /*break*/, 12];
                            case global_1.RequestMethod.pauseConsumer: return [3 /*break*/, 13];
                            case global_1.RequestMethod.resumeConsumer: return [3 /*break*/, 14];
                        }
                        return [3 /*break*/, 15];
                    case 1:
                        {
                    ...
                    case 5:
                        ...
                        transport = peer.getTransport(transportId);
                        return [4 /*yield*/, transport.connect(dtlsParameters)];
                    case 6:
                        _f.sent();
                        callback(null, {});
                        return [3 /*break*/, 16];
