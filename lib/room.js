...
var Room = /** @class */ (function (_super) {
    ...
    Room.prototype._handleRequest = function (peer, request, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, displayName, joined, device, rtpCapabilities, joinedPeers, peerInfos_1, _c, sctpCapabilities, transportType, webRtcTransportOptions, transport, _d, transportId, dtlsParameters, transport, subscribeIds, subscribedInfo, _i, subscribeIds_1, id, subscribedPeer, _e, _f, producer, _g, _h, _j, transportId, kind, rtpParameters, appData, transport, error, producer, producerId, producer, error, producerId, producer, error, producerId, producer, error, consumerId, consumer, error, consumerId, consumer, error;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 8:
                        ...
                        _e = 0, _f = subscribedPeer.getAllProducer();
                        _k.label = 9;
                    case 9:
                        if (!(_e < _f.length)) return [3 /*break*/, 12];
                        producer = _f[_e];
                        _h = (_g = subscribedInfo).push;
                    ...
                    case 14:
                        ...
                        _j = request.data, transportId = _j.transportId, kind = _j.kind, rtpParameters = _j.rtpParameters;
