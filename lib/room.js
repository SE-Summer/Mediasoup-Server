...
var Room = /** @class */ (function (_super) {
    ...
    Room.prototype._handleRequest = function (peer, request, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, displayName, joined, device, rtpCapabilites, joinedPeers, peerInfos, _c, sctpCapabilities, transportType, webRtcTransportOptions, transport, _d, transportId, dtlsParameters, transport, subscribeId, subscribedInfo_1, _e, transportId, kind, rtpParameters, appData, transport, error, producer, producerId, producer, error, producerId, producer, error, producerId, producer, error, consumerId, consumer, error, consumerId, consumer, error;
            var _this = this;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case global_1.RequestMethod.resumeConsumer: return [3 /*break*/, 17];
                        }
                        return [3 /*break*/, 19];
                    case 1:
                        {
