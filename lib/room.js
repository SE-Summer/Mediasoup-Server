...
var Room = /** @class */ (function (_super) {
    ...
    Room.prototype._getJoinedPeers = function (_a) {
        var _b = (_a === void 0 ? {} : _a).excludePeer, excludePeer = _b === void 0 ? undefined : _b;
                ...
                if (peerArray.length !== 1) {
                    ...
                    mysqlDB.setHost(newHost_1.id, _this._roomId, function (error, res) {
                        if (res) {
                            ...
                            global_2._notify(newHost_1.socket, 'hostChanged', { newHostId: newHost_1.id }, true, _this._roomId);
                        }
                        else {
                            throw Error(error);
                        }
    ...
    Room.prototype._handleRequest = function (peer, request, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, displayName_1, avatar_1, joined, device_1, rtpCapabilities_1, sctpCapabilities_1, error, error, error, host_1, _c, sctpCapabilities, transportType, webRtcTransportOptions, transport_1, _d, transportId, dtlsParameters, transport, _e, transportId, kind, rtpParameters, appData, transport, error, producer_1, joinedPeers, _f, transportId, sctpStreamParameters, protocol, transport, dataProducer_1, joinedPeers, producerId, producer, error, producerId, producer, error, producerId, producer, error, consumerId, consumer, error, consumerId, consumer, error, _g, toPeerId, timestamp, text, message, recvPeer, error, _h, fileURL, timestamp, filename, fileType, message, error, kickedPeerId, error, kickedPeer, mutedPeerId, error, _i, _j, peer_1, _k, _l, audio, mutedPeer, error, _m, _o, audio, hostId_1, error, newHost_2, error, transportId, transport, error, iceParameters, error;
            var _this = this;
            return __generator(this, function (_p) {
                switch (_p.label) {
                    ...
                    case 27:
                        ...
                        if (!(mutedPeerId == null)) return [3 /*break*/, 34];
                    ...
                    case 29:
                        ...
                        audio = _l[_k];
                        global_2._notify(peer_1.socket, 'beMuted', { producerId: audio.id });
                        return [4 /*yield*/, audio.close()];
                    case 30:
                        _p.sent();
                        peer_1.deleteProducer(audio.id);
                        _p.label = 31;
                    case 31:
                        _k++;
                        return [3 /*break*/, 29];
                    ...
                    case 39:
                        {
                            ...
                            mysqlDB.setHost(hostId_1, this._roomId, function (error, res) {
                                if (res) {
                                    ...
                                    global_2._notify(newHost_2.socket, 'hostChanged', { newHostId: hostId_1 }, true, _this._roomId);
                                    callback();
                                }
                                else {
                                    callback(error);
