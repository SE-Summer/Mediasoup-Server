...
var Room = /** @class */ (function (_super) {
    ...
    Room.prototype._handleRequest = function (peer, request, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, displayName, joined, device, rtpCapabilities, joinedPeers, peerInfos_1, _c, sctpCapabilities, transportType, webRtcTransportOptions, transport, _d, transportId, dtlsParameters, transport, _e, transportId, kind, rtpParameters, appData, transport, error, producer_1, joinedPeers, producerId, producer, error, producerId, producer, error, producerId, producer, error, consumerId, consumer, error, consumerId, consumer, error;
            var _this = this;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case global_1.RequestMethod.closeProducer: return [3 /*break*/, 9];
                            case global_1.RequestMethod.pauseProducer: return [3 /*break*/, 10];
                            case global_1.RequestMethod.resumeProducer: return [3 /*break*/, 12];
                            case global_1.RequestMethod.pauseConsumer: return [3 /*break*/, 14];
                            case global_1.RequestMethod.resumeConsumer: return [3 /*break*/, 16];
                            case global_1.RequestMethod.close: return [3 /*break*/, 18];
                        }
                        return [3 /*break*/, 19];
                    case 1:
                        {
